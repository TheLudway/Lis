export default function SobreMi() {
    return (
        <div class="bg-linear-to-r from-primary to-primary-darkBlue w-full">
            <div class="p-10">
                <h1 class="font-code-bold text-secundary-white sm:text-1xl md:text-2xl lg:text-3x1">About me</h1>
                <p className="font-code text-secundary-white p-5 text-xs text-justify">
